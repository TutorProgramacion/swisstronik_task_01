 ...
 */
contract PCMA is PERC20 {
    constructor() PERC20("PCMA", "PCA") {}
    ...
    function balanceOf(address account) public view override returns (uint256) {
        ...
        require(msg.sender == account, "PCMA: msg.sender != account");
    ...
    function allowance(
        ...
        // extract original sender of this request. In case of regular (non-signed) `eth_call`
        // msg.sender will be empty address (0x0000000000000000000000000000000000000000)
        require(msg.sender == spender, "PCMA: msg.sender != account");
